...
//#define STRING_CONFIG_H_AUTHOR "(Tan PS, Factory Controller Board)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Mega Zero"
 ...
 */
#define PROBE_MANUALLY    //ps: bed level
